...
display block creates a block level element and display inline creates inline level element and block level elements break up the flow of document and inline level element doesnt break document flow
...
it helps with working on one project at the same time and each person can see commits and its helpfull if you mess up and want to return to an older version.
